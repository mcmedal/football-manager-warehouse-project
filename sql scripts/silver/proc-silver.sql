...
BEGIN
	...
	--- FMDATA_TEAM_PLAYERS
		...
		PRINT '>>TRUNCATING: silver.fmdata_team_players';
		TRUNCATE TABLE silver.fmdata_team_players;

		PRINT '>>> INSERTING DATA INTO: silver.fmdata_team_players';
		INSERT INTO silver.fmdata_team_players
			...
			red_cards_per90, wage_per_week_k, transfer_value_m)
		SELECT
			player_id,
			player_name,
			club_name,
		...
		PRINT '---------------------------------------------';
		SET @start_time = GETDATE();
		PRINT '>>TRUNCATING: silver.fmdata_team_gks';
		TRUNCATE TABLE silver.fmdata_team_gks;

		PRINT '>>> INSERTING DATA INTO: silver.fmdata_team_gks';
		INSERT INTO silver.fmdata_team_gks
			...
			distance_covered_km_per90, mistakes_leading_to_goals_per90, fouls_against_per90, wage_per_week_k, transfer_value_m)
		SELECT
			player_id,
			player_name,
			club_name,
		...
		PRINT '---------------------------------------------';
		SET @start_time = GETDATE();
		PRINT '>>TRUNCATING: silver.fmdata_manager_data';
		TRUNCATE TABLE silver.fmdata_manager_data;

		PRINT '>>> INSERTING DATA INTO: silver.fmdata_manager_data';
		...
		PRINT '---------------------------------------------';
		SET @start_time = GETDATE();
		PRINT '>>TRUNCATING: silver.fmdata_interested_out_players';
		TRUNCATE TABLE silver.fmdata_interested_out_players;

		PRINT '>>> INSERTING DATA INTO: silver.fmdata_interested_out_players';
		...
		) AS silverfmdata_interested_out_players1;
		...
		) AS silverfmdata_interested_out_players2;
		...
		) AS silverfmdata_interested_out_players3;
		...
		PRINT '---------------------------------------------';
		SET @start_time = GETDATE();
		PRINT '>>TRUNCATING: silver.fmdata_interested_gks';
		TRUNCATE TABLE silver.fmdata_interested_gks;

		PRINT '>>> INSERTING DATA INTO: silver.fmdata_interested_gks';
		...
		) AS silverfmdata_interested_gks;
